...
async def test_individual_agents():
    ...
    try:
        ...
        architect = ChiefArchitect(dashscope_key, llm_base_url, "qwen3.8-flash")
    ...
    try:
        ...
        scout = DeepScout(dashscope_key, llm_base_url, bocha_key, "qwen3.8-flash")
    ...
    try:
        ...
        wizard = CodeWizard(dashscope_key, llm_base_url, "qwen3.8-flash")
