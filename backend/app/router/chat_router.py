...
from models.chat import ChatAttachment, ChatMessage
...
def ensure_redis_session_history(session_id: str, session_service: SessionService, db: Session) -> None:
    """首次切换到普通问答时，用 PostgreSQL 会话记录初始化 Redis 上下文。"""
...
async def chat_completion(
    ...
    if request.session_id:
        ensure_redis_session_history(request.session_id, session_service, db)
