...
class ResearchState(TypedDict):
    ...
    review_result: Optional[Dict[str, Any]] # 当前正式报告对应的审核结果
    review_history: List[Dict[str, Any]]    # 历史报告版本的审核结果
    review_is_current: bool                # 审核是否对应当前 final_report
    review_status: str                     # pending/passed/needs_revision
    report_version: int                    # 正式报告版本号
